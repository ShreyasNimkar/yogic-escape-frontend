        ...
        <div className="w-full h-full flex justify-around items-center px-[6%] gap-[1rem] overflow-y-hidden">
          ...
          <div className="w-[35%] text-xs  gap-3 hidden items-center justify-end lg:flex">
            <div className="group relative cursor-pointer hover:text-mahogany flex justify-around items-start flex-col">
              ...
              <div className="hidden opacity-0 fixed group-hover:flex group-hover:opacity-100 group-hover:transition-all group-hover:duration-700 ease-out bg-transparent rounded-b-md top-[16.7vh] z-30  justify-around items-center flex-col">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 15 2"
          ...
          <div className="w-[35%] text-xs gap-3 hidden items-center justify-start lg:flex">
            ...
            <div className="group relative cursor-pointer hover:text-mahogany flex justify-around items-start flex-col">
              <div className="group-hover:underline">RETREATS & EVENTS</div>
            ...
            <div className="group relative cursor-pointer hover:text-mahogany flex justify-around items-start flex-col">
              <div className="group-hover:underline">MORE</div>
