...
const MassagesAndTherapiesHeroSection = () => {
  return (
    <>
          ...
          <div className="flex flex-col items-center justify-around ">
              ...
              <div className="w-full h-full bg-[#250706] bg-opacity-50">
                <div className="h-[60%] w-full flex justify-around items-end text-center">
                  <p className="w-full  font-thin text-center text-white text-5xl sm:text-6xl h-[55%] overflow-y-hidden ">
                    <span className="font-Quasonnnn">Massages and</span>
                    <br />
                    <span className="italic  font-light">THERAPIES&nbsp;</span>
                  </p>
                </div>
            ...
            <div className=" bg-paleIvory h-full w-full">
              <div className="text-center  tracking-[0.2rem] h-[40vh] w-full bg-chakra-bg bg-center bg-no-repeat bg-contain flex items-center justify-around my-5 ">
                <div className="sm:w-[70%] font-Quasonnnn  text-xl sm:text-3xl">
                  Massage is a type of therapy that is used to treat various
                  ailments and conditions. It has been found to help reduce
                  stress and anxiety, improve sleep, increase blood circulation,
                  reduce muscle tension, relieve pain, and more.
                </div>
              </div>
            </div>
          </div>
...
export default MassagesAndTherapiesHeroSection;
