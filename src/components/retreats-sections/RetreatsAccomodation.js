...
const RetreatsAccomodation = () => {
  return (
    <>
      {" "}
      <Title color={"white"} value={"ACCOMODATIONS"} />
      <div className="w-full h-[50vh] sm:h-[100%] bg-white">
        <div className="flex flex-col lg:flex-row-reverse justify-around h-full w-full items-center">
          <div className="w-full lg:w-1/2 h-full flex flex-col justify-end items-end">
            <div className="flex justify-around  lg:justify-end sm:pb-3 items-start text-center md:py-0 sm:text-left h-[45%] sm:h-[45%] pt-3 sm:pt-0 text-xl sm:text-2xl font-semibold w-full px-[4rem] lg:text-end">
              <p>
                Cozy Ashram
                <br className="block sm:hidden" /> with
                <span className="text-mahogany h-max w-max">
            ...
            <div className="flex sm:py-5 justify-around lg:justify-end items-center h-[50%] sm:h-[35%] w-full px-[4rem]">
              <button
                ...
                type="button"
              >
                <span className="text-base pt-[0.25rem]">Know More</span>
                <svg
          ...
          <div className="w-4/5 flex justify-start items-center sm:h-full h-[45vh] ">
            <Image
              src={"/soundhealing.png"}
              alt="yoga-ppl"
              height={10000}
              width={10000}
              className="h-full sm:h-[45vh]  object-contain "
            />
          </div>
        </div>
      </div>
...
export default RetreatsAccomodation;
